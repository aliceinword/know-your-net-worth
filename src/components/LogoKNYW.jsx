...
// KYNW Header with coin-style logo and stylized app name
const LogoKYNW = ({ style, className }) => (
  <header className={`bg-white shadow-sm rounded-lg px-4 py-2 max-w-xs flex items-center space-x-3 ${className || ''}`} style={style}>
    {/* KYNW Coin Logo */}
    <div className="flex-shrink-0">
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* KYNW text in center with better positioning */}
        <text 
          x="24" 
          y="28" 
    ...
    <div className="flex flex-col">
      <span className="text-base font-semibold text-gray-800 leading-tight">
        <span className="font-bold text-black text-lg">K</span><span className="text-xs text-gray-500">now</span>
        <span className="font-bold text-black text-lg ml-1">Y</span><span className="text-xs text-gray-500">our</span>
        <span className="font-bold text-black text-lg ml-1">N</span><span className="text-xs text-gray-500">et</span>
        <span className="font-bold text-black text-lg ml-1">W</span><span className="text-xs text-gray-500">orth</span>
      </span>
    </div>
